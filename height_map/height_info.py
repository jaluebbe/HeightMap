...
def get_height(lat, lon, ice=True, water=True):
    ...
    if (dist_dgm200 < 25) and (h_dgm200 != dgm200.NODATA) and (
            h_earth2014 == earth2014.NODATA or h_earth2014 >= 0):
    ...
    if h_terr50 != terr50.NODATA and (h_earth2014 == earth2014.NODATA or
            h_earth2014 >= 0 or h_terr50 > 0 or h_earth2014 > h_terr50):
        # prefer sea floor bathymetry if possible
    ...
    if h_srtm1 != srtm1.NODATA and h_srtm1 != 0:
        ...
        return (h_srtm1, 'SRTM1', lat_srtm1, lon_srtm1,
            ...
            srtm1.attribution)
    if h_dgm200 != dgm200.NODATA and (h_earth2014 == earth2014.NODATA or
            h_earth2014 >= 0):
        # prefer sea floor bathymetry if possible
